...
class OnSplittedTensor(Operation):
    ...
    def __init__(self, operation: Operation, dim: int = 0):
        """Initialize `OnSplittedTensor` object.
...
class IfElse(Operation):
    ...
    def __init__(
        self,
        condition: bool,
        operation1: typing.Callable[
            [
                typing.Any,
            ],
            typing.Any,
        ],
        operation2: typing.Callable[
            [
                typing.Any,
            ],
            typing.Any,
